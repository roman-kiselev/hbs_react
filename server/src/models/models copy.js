...
PriborNumberChanel.init(
    ...
    {
        sequelize,
        modelName: "pribor_number_chanel",
    }
);
...
PriborNumberChanelNumberMeters.init(
    ...
    {
        sequelize,
        modelName: "p_n_chanel_m_n",
    }
);
PriborNumberChanel.belongsToMany(MeterNumber, {
    through: PriborNumberChanelNumberMeters,
});
MeterNumber.belongsToMany(PriborNumberChanel, {
    through: PriborNumberChanelNumberMeters,
});
...
export default {
    ...
    Chanel,
    PriborNumberChanel,
    PriborNumberChanelNumberMeters,
    PriborNumberChanelFlat,
    PriborNumberChanelOffice,
    MainAddMeter,
};
