...
export const createSections = createAsyncThunk('api/sections', async ({formData}, {rejectedWithValue, dispatch}) => {
...
export const {addSections, setSections, removeSections} = sectionsSlice.actions;
