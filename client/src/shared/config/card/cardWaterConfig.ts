...
export const cardWaterConfig: ICardLink[] = [
    {
        title: "Стандарт",
        subtitle: "Старое",
        textCard: "Обычное добавление",
        to: [
            {
                title: "Вперёд",
                link: "temporaryPage",
    ...
    },
    {
        ...
        subtitle: "Новое",
        textCard: "Пересмотренное устаревшее",
        to: [
            {
                title: "Вход",
                link: "newOld",
    ...
    },
    {
        ...
        textCard: "Здесь различные варианты работы с счётчиками пульсар",
        to: [
            {
                title: "Вперёд",
                link: "pulsar",
