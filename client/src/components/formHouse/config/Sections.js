class Sections {
  ...
  getData() {
    console.log(this.numberSection, this.sumFloors, this.lines, this.typeAsr);
  }
  ...
  dataCount() {
    ...
    console.log(`Количество АСР-8: ${countAsr8}`);
    console.log(`Количество АСР-2: ${countAsr2}`);
    console.log(`Количество каналов: ${countChannels}`);
    console.log(`Количество КДЛ: ${countKdl}`);
    console.log(
      `Количество счётчиков на одном этаже: ${amountMetersOnLineAll}`
    );
  }
}
