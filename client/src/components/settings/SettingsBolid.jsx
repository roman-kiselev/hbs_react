...
import {Col, Nav, Tab, Row, Button, Modal, Form} from "react-bootstrap";
import AddSections from "../../modals/settings/AddSections";
import AddLine from "../../modals/settings/AddLine";
import AddFlat from "../../modals/settings/AddFlat";
import AddFloors from "../../modals/settings/AddFloors";
import AddOffice from "../../modals/settings/AddOffice";
...
const SettingsBolid = () => {
    ...
    return (
        <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                    ...
                    <Tab.Content>
                        <Tab.Pane eventKey="objects">
                            <Row>
                                <Row>
                                    <Col>
                                        <Button variant="primary" onClick={sectionsHandleShow}>
                                            Добавить секции
                                        </Button>
                                    </Col>
                                    <Col>
                                        <Button variant="primary" onClick={lineHandleShow}>
                                            Добавить линии
                                        </Button>
                                    </Col>
                                    <Col>
                                        <Button variant="primary" onClick={floorsHandleShow}>
                                            Добавить этажи
                                        </Button>
                                    </Col>
                                    <Col>
                                        <Button variant="primary" onClick={flatHandleShow}>
                                            Добавить квартиры
                                        </Button>
                                    </Col>
                                    <Col>
                                        <Button variant="primary" onClick={officeHandleShow}>
                                            Добавить офисы
                                        </Button>
                                    </Col>
                                </Row>
            ...
            <Row>
                <>
                    <AddSections show={sectionsShow} onHide={() => sectionsHandleClose()}/>
                    <AddLine show={lineShow} onHide={() => lineHandleClose()}/>
                    <AddFlat show={flatShow} onHide={() => flatHandleClose()}/>
                    <AddFloors show={floorsShow} onHide={() => floorsHandleClose()}/>
                    <AddOffice show={officeShow} onHide={() => officeHandleClose()}/>
